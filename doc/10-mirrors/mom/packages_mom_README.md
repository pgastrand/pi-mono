---
aliases: ["PI Mom README", "packages_mom_README", "Packages Mom Readme"]
type: readme
package: mom
topics:
  - mom
...
- [Artifacts Server](docs/packages_mom_docs_artifacts-server.md) - Share HTML/JS visualizations publicly with live reload
- [Events System](docs/packages_mom_docs_events.md) - Schedule reminders and periodic tasks
- [Sandbox Guide](docs/packages_mom_docs_sandbox.md) - Docker vs host mode security
- [Slack Bot Setup](docs/packages_mom_docs_slack-bot-minimal-guide.md) - Minimal Slack integration guide
