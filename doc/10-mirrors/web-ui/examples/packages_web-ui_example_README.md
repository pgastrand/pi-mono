---
aliases: ["Packages Web Ui Example Readme", "packages_web-ui_example_README"]
type: readme
package: web-ui
topics:
  - web-ui
...
- [Pi Web UI Documentation](../packages_web-ui_README.md)
- [Pi AI Documentation](../../ai/packages_ai_README.md)
