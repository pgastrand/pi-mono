---
aliases: ["Pods Docs - Plan", "packages_pods_docs_plan", "Packages Pods Docs Plan"]
type: plan
package: pods
topics:
  - pods
...
See [models.md](./packages_pods_docs_models.md) for a list of models, their HW reqs, vLLM args and notes, we want to support out of the box with a simple `pi start <model-name> --name <local-name>`