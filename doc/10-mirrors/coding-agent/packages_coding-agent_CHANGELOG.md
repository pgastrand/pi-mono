---
aliases: ["PI Coding Agent Changelog", "packages_coding-agent_CHANGELOG", "Packages Coding Agent Changelog"]
type: changelog
...
- Extension terminal input interception via `terminal_input`, allowing extensions to consume or transform raw input before normal TUI handling. See [docs/extensions.md](docs/packages_coding-agent_docs_extensions.md).
- Expanded CLI model selection: `--model` now supports `provider/id`, fuzzy matching, and `:<thinking>` suffixes. See [README.md](packages_coding-agent_README.md) and [docs/models.md](docs/packages_coding-agent_docs_models.md).
- Safer package source handling with stricter git source parsing and improved local path normalization. See [docs/packages.md](docs/packages_coding-agent_docs_packages.md).
...
- Extensions can trigger a full runtime reload via `ctx.reload()`, useful for hot-reloading configuration or restarting the agent. See [docs/extensions.md](docs/packages_coding-agent_docs_extensions.md) and the [`reload-runtime` example](examples/extensions/reload-runtime.ts) ([#1371](https://github.com/badlogic/pi-mono/issues/1371))
...
- Extensions can programmatically paste content into the editor via `pasteToEditor` in the extension UI context. See [docs/extensions.md](docs/packages_coding-agent_docs_extensions.md) ([#1351](https://github.com/badlogic/pi-mono/pull/1351) by [@kaofelix](https://github.com/kaofelix))
...
- Bedrock proxy support for unauthenticated endpoints via `AWS_BEDROCK_SKIP_AUTH` and `AWS_BEDROCK_FORCE_HTTP1`. See [docs/providers.md](docs/packages_coding-agent_docs_providers.md).
...
- SSH URL support for git packages. See [docs/packages.md](docs/packages_coding-agent_docs_packages.md).
- `auth.json` API keys now support shell command resolution (`!command`) and environment variable lookup. See [docs/providers.md](docs/packages_coding-agent_docs_providers.md).
...
- Configurable resume keybinding action for opening the session resume selector. See [docs/keybindings.md](docs/packages_coding-agent_docs_keybindings.md). ([#1249](https://github.com/badlogic/pi-mono/pull/1249) by [@juanibiapina](https://github.com/juanibiapina))
...
- Extension tool output expansion controls via ExtensionUIContext getToolsExpanded and setToolsExpanded. See [docs/extensions.md](docs/packages_coding-agent_docs_extensions.md) and [docs/rpc.md](docs/packages_coding-agent_docs_rpc.md).
...
- **Extension API switchSession**: Extensions can now programmatically switch sessions via `ctx.switchSession(sessionPath)`. See [docs/extensions.md](docs/packages_coding-agent_docs_extensions.md). ([#1187](https://github.com/badlogic/pi-mono/issues/1187))
...
- **Bash spawn hook**: Extensions can now intercept and modify bash commands before execution via `pi.setBashSpawnHook()`. Adjust the command string, working directory, or environment variables. See [docs/extensions.md](docs/packages_coding-agent_docs_extensions.md). ([#1160](https://github.com/badlogic/pi-mono/pull/1160) by [@mitsuhiko](https://github.com/mitsuhiko))
...
- **Named session filter**: `/resume` picker now supports filtering to show only named sessions via Ctrl+N. Configurable via `toggleSessionNamedFilter` keybinding. See [docs/keybindings.md](docs/packages_coding-agent_docs_keybindings.md). ([#1128](https://github.com/badlogic/pi-mono/pull/1128) by [@w-winter](https://github.com/w-winter))
...
- **Shell-style keybindings**: `alt+b`/`alt+f` for word navigation, `ctrl+d` for delete character forward. See [docs/keybindings.md](docs/packages_coding-agent_docs_keybindings.md).
- **RPC `get_commands`**: Headless clients can now list available commands programmatically. See [docs/rpc.md](docs/packages_coding-agent_docs_rpc.md).
...
- Pi packages for bundling and installing extensions, skills, prompts, and themes. See [docs/packages.md](docs/packages_coding-agent_docs_packages.md).
...
- Custom providers via `pi.registerProvider()` for proxies, custom endpoints, OAuth or SSO flows, and non-standard streaming APIs. See [docs/custom-provider.md](docs/packages_coding-agent_docs_custom-provider.md).
...
- OpenRouter routing support for custom models via `openRouterRouting`. See [docs/providers.md#api-keys](docs/providers.md#api-keys) and [docs/models.md](docs/packages_coding-agent_docs_models.md).
...
- Session selector renaming and configurable keybindings. See [README.md#commands](README.md#commands) and [docs/keybindings.md](docs/packages_coding-agent_docs_keybindings.md).
...
- [docs/extensions.md](docs/packages_coding-agent_docs_extensions.md) - Full API reference
- [README.md](packages_coding-agent_README.md) - Extensions section with examples
...
See [docs/session.md](docs/packages_coding-agent_docs_session.md) for the file format and `SessionManager` API.
...
See [docs/sdk.md](docs/packages_coding-agent_docs_sdk.md) and [examples/sdk/](examples/sdk/) for the current API.
...
See [docs/rpc.md](docs/packages_coding-agent_docs_rpc.md) for the current protocol.
...
The `before_compact` and `before_tree` hook events allow custom compaction implementations. See [docs/compaction.md](docs/packages_coding-agent_docs_compaction.md).
...
Total color count increased from 46 to 50. See [docs/themes.md](docs/packages_coding-agent_docs_themes.md) for the full color list and copy values from the built-in dark/light themes.
...
- **SDK API changes** ([#296](https://github.com/badlogic/pi-mono/issues/296)):
  ...
  - See updated [SDK documentation](docs/packages_coding-agent_docs_sdk.md) and [README](packages_coding-agent_README.md)
...
- **New RPC protocol**: The RPC mode (`--mode rpc`) has been completely redesigned with a new JSON protocol. The old protocol is no longer supported. See [`docs/rpc.md`](docs/packages_coding-agent_docs_rpc.md) for the new protocol documentation and [`test/rpc-example.ts`](test/rpc-example.ts) for a working example. Includes `RpcClient` TypeScript class for easy integration. ([#91](https://github.com/badlogic/pi-mono/issues/91))
